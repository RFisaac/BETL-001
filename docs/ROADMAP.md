...
object detection, (2) teleop-drive-while-mapping. Trained policies in Isaac Lab are a bonus.
...
- [x] Long-lead parts ordered (drivers, micros, power, LEDs, encoders)
...
cinematography platform; interior 3D scanning; machine learning experiments; robust suspension.
